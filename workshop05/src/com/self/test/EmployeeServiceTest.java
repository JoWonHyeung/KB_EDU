...
public class EmployeeServiceTest {
	public static void main(String[] args) {
		//1. Service 객체를 생성
		EmployeeService service = new EmployeeServiceImpl(100);
		...
		Employee[] retMs1 = service.findManagerByDeptno(10);
		...
		System.out.println("\n=========== 6. getBirthDayMoreThan =============");
		System.out.println(service.getBirthDayMoreThan(1990));
	}
}
